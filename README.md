...
| --------| -------------------------------| --------- | -------
|         | **Introduction** |
| Jan 20  | [Analysis of Large-Scale Multi-Tenant GPU Clusters for DNN Training Workloads](http://web.eecs.umich.edu/~mosharaf/Readings/Fiddle-Philly.pdf) | Mosharaf
